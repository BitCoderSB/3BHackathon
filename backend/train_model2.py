...
def main():
    print(f"=== Entrenamiento YOLOv8-seg — Anaquel 3B (V2) ===")
    ...
    # Entrenar con hiperparámetros optimizados para pocos datos
    results = model.train(
        ...
        device=DEVICE,
        task="segment",
        name="anaquel_3b_v2",   # Guardamos en carpeta nueva para no mezclar
        project=str(ROOT / "runs"),
        patience=30,            # Si ya no aprende en 30 épocas, se detiene solo
        optimizer="AdamW",      # Excelente optimizador para segmentación
